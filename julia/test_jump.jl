# simple test code from: https://github.com/JuliaOpt/JuMP.jl/blob/master/examples/basic.jl
...
#############################################################################
# Slightly modified by Paul Hines, Packetized Energy
